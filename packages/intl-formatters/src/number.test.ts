import type { CurrencyFormatterOptions } from "@onigoetz/i18n-types";
...
test("Formats currencies", () => {
  ...
  // Node 10 has different formatting rules
  expect(currencyFormatter("zh", "USD", name)(teslaS)).toEqual(
