...
const renderer = createRenderer(
  ...
  pluralGenerator,
  (cldr, options, value) => {
    //return numberFormatter(cldr, options)(value);
  },
  (cldr, options, value) => {
    //return dateFormatter(cldr, options)(value);
  }
);
